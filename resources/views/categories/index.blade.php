...
<div class="flex justify-between items-center mb-6">
    ...
    <div class="flex gap-2">
        <a href="{{ route('categories.export-pdf') }}" class="px-4 py-2 bg-gray-600 text-white text-sm rounded-md hover:bg-gray-500">Export PDF</a>
        <a href="{{ route('categories.export-excel') }}" class="px-4 py-2 bg-gray-600 text-white text-sm rounded-md hover:bg-gray-500">Export Excel</a>
        <a href="{{ route('categories.create') }}" class="px-4 py-2 bg-gray-800 text-white text-sm rounded-md hover:bg-gray-700">Tambah</a>
    </div>
</div>
...
<div class="mt-4 bg-white border border-gray-200 rounded-lg p-4 max-w-sm">
    ...
    <form action="{{ route('categories.import') }}" method="POST" enctype="multipart/form-data" class="flex gap-2">
        @csrf
