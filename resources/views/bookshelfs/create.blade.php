...
@section('content')
<div class="max-w-lg">
    <h1 class="text-xl font-semibold mb-6">Tambah Rak Buku</h1>
        ...
        <form action="{{ route('bookshelfs.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="code"
                    ...
                    value="{{ old('code') }}" placeholder="Contoh: A1">
                @error('code')
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name"
                    ...
                    value="{{ old('name') }}" placeholder="Masukkan nama rak">
                @error('name')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            <div class="flex gap-2">
                ...
                <button type="submit"
                   class="px-4 py-2 text-sm bg-gray-800 text-white rounded-md hover:bg-gray-700">Simpan</button>
            </div>
        </form>
    </div>
</div>
